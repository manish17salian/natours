...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend MapBound to include current location
...
var stripe = Stripe('pk_test_51IrHPNSE8AnQKrMmIPumOrS9H7eCKMa45zh60bbSVOraWMqDo5pIrXgotUh6qruxh6KqYBPpTSJdrfHNziMB4h1300UtFBWOOB');
